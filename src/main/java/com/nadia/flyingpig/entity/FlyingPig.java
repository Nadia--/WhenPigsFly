...
public class FlyingPig extends EntityBat {
	...
	public FlyingPig(World par1World) {
		super(par1World);
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        for (int k = 0; k < z; ++k)
        {
            this.dropItem(WhenPigsFlyMod.zircon, 1);
        }
        
    }

    
    public FlyingPig createChild(EntityAgeable par1EntityAgeable)
    {
        return new FlyingPig(this.worldObj);
    }
